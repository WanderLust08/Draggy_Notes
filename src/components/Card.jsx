...
const Card = ({data,refer}) => {
  return (
    <motion.div drag dragConstraints={refer} whileDrag={{scale:1.2}} className="relative flex-shrink-0 w-60 h-72 rounded-[45px] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden ">
        <FaRegFileAlt />
        <p className='text-md leading-tight mt-5 font-semibold '>{data.desc}</p>
